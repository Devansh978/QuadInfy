    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          setSubmissionStatus("error");
          setSubmissionMessage(
            `Sorry, something went wrong. ${error.text || "Please try again later."}`,
          );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-14 md:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
            Ready to start your project? Get in touch and let's build something
            amazing.
          </p>
        </div>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="devansh@quadinfy.com"
                    onBlur={handleBlur}
                    onChange={handleChange}
                  />
                  {formErrors.user_email && (
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white/80 hover:text-white text-sm sm:text-base break-all"
                    >
                      quadinfy@gmail.com
                    </a>
                  </div>
